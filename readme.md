...
This will create an executable jar file **microprofile-microbundle.jar** within the _target_ maven folder. This can be started by executing the following command
